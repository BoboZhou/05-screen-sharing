...
/** ----- 参数定义 ----- */
var BlinkGlobal = {
	/** 定义环境，0为私有云环境，1为生产环境，2为演示环境1，22为演示环境2，3为测试环境，4为本地环境，5为开发环境1，52为开发环境2 */
	envType : '3',
	/** 带宽设置计数器 */
	bandWidthCount : 0
}
...
//	TOKEN_URL_PROD : 'https://api.blinktalk.io:8800/token',
	TOKEN_URL_PROD : 'https://api.blinkcloud.cn:8800/token',
	/** 获取TOKEN的地址——演示环境1 */
	TOKEN_URL_DEMO1 : 'https://api.blinktalk.site:8800/token',
	/** 获取TOKEN的地址——演示环境2 */
	TOKEN_URL_DEMO2 : 'https://api.blinktalk.top:8800/token',
	/** 获取TOKEN的地址——测试环境 */
...
//	WS_NAV_URL_PROD : 'https://api.blinktalk.io:8081/websocketlist',
	WS_NAV_URL_PROD : 'https://api.blinkcloud.cn:8081/websocketlist',
	/** websocket导航地址——演示环境1 */
	WS_NAV_URL_DEMO1 : 'https://api.blinktalk.site:8080/websocketlist',
	/** websocket导航地址——演示环境2 */
	WS_NAV_URL_DEMO2 : 'https://api.blinktalk.top:8080/websocketlist',
	/** websocket导航地址——测试环境 */
	...
	/** websocket导航地址——开发环境2 */
	WS_NAV_URL_DEV2 : 'https://10.10.30.165:8081/websocketlist',
	/** websocket地址——本地环境 */
...
BlinkEngine.prototype.init = function(wsNavUrl) {
	...
	if (wsNavUrl != null && wsNavUrl != '') {
		...
		this.wsNavUrl = BlinkUtil.getWsNavUrl(BlinkGlobal.envType);
	}
...
BlinkEngine.prototype.createSignaling = function() {
	...
	switch (BlinkGlobal.envType) {
	case BlinkConstant.EnvType.LOCAL:
		this.createSignalingWithUrl(BlinkConstant.WS_URL_LOCAL);
		return;
	default:
...
var BlinkUtil = {
	 ...
	 * 
	 */
	getTokenUrl : function(envType) {
		switch (envType) {
		case BlinkConstant.EnvType.PROD:
			return BlinkConstant.TOKEN_URL_PROD;
		case BlinkConstant.EnvType.DEMO1:
			return BlinkConstant.TOKEN_URL_DEMO1;
		case BlinkConstant.EnvType.DEMO2:
			return BlinkConstant.TOKEN_URL_DEMO2;
		case BlinkConstant.EnvType.TEST:
			return BlinkConstant.TOKEN_URL_TEST;
		case BlinkConstant.EnvType.LOCAL:
			return BlinkConstant.TOKEN_URL_LOCAL;
		case BlinkConstant.EnvType.DEV1:
			return BlinkConstant.TOKEN_URL_DEV1;
		case BlinkConstant.EnvType.DEV2:
			return BlinkConstant.TOKEN_URL_DEV2;
		default:
			return BlinkConstant.TOKEN_URL_TEST;
		}
	},
	 ...
	 * 
	 */
	getWsNavUrl : function(envType) {
		switch (envType) {
		case BlinkConstant.EnvType.PROD:
			return BlinkConstant.WS_NAV_URL_PROD;
		case BlinkConstant.EnvType.DEMO1:
			return BlinkConstant.WS_NAV_URL_DEMO1;
		case BlinkConstant.EnvType.DEMO2:
			return BlinkConstant.WS_NAV_URL_DEMO2;
		case BlinkConstant.EnvType.TEST:
			return BlinkConstant.WS_NAV_URL_TEST;
		case BlinkConstant.EnvType.LOCAL:
			return BlinkConstant.WS_NAV_URL_LOCAL;
		case BlinkConstant.EnvType.DEV1:
			return BlinkConstant.WS_NAV_URL_DEV1;
		case BlinkConstant.EnvType.DEV2:
			return BlinkConstant.WS_NAV_URL_DEV2;
		default:
			return BlinkConstant.WS_NAV_URL_TEST;
		}
	},
